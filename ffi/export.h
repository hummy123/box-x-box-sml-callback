#ifndef __BOX_X_BOX_ML_H__
#define __BOX_X_BOX_ML_H__
...
#if !defined(PART_OF_BOX_X_BOX) && \
    !defined(STATIC_LINK_BOX_X_BOX) && \
    !defined(DYNAMIC_LINK_BOX_X_BOX)
#define PART_OF_BOX_X_BOX
#endif

#if defined(PART_OF_BOX_X_BOX)
#define MLLIB_PRIVATE(x) PRIVATE x
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(STATIC_LINK_BOX_X_BOX)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) PUBLIC x
#elif defined(DYNAMIC_LINK_BOX_X_BOX)
#define MLLIB_PRIVATE(x)
#define MLLIB_PUBLIC(x) EXTERNAL x
#else
#error Must specify linkage for box_x_box
#define MLLIB_PRIVATE(x)
